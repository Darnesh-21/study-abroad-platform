...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 YOU CAN AFFORD THIS!
   ...
   for many great universities worldwide!"""
    ...
    elif question_type == "career_outcomes":
        
        return f""" YOUR CAREER PATH AFTER STUDYING ABROAD
...
Degree: {profile.intended_degree}
Field: {profile.field_of_study}
Target Countries: {profile.preferred_countries or 'Multiple'}
Expected Graduation: ~{profile.target_intake_year + 2}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

⏳ PHASE 1: IMMEDIATE OUTCOMES (First 6-12 Months)

 POST-STUDY WORK VISA (MAJOR ADVANTAGE!)

You can legally WORK in your study country after graduation:

 USA (F-1 OPT - Optional Practical Training)
   └─ Duration: 12 months (STEM: 24-36 months) 
   └─ Work: Any employer (no sponsorship initially needed)
   └─ Salary: $60,000-$100,000/year (entry-level)
   └─ Path: Often leads to H-1B sponsorship
   └─ Value: MASSIVE advantage in US job market

 UK (Graduate Visa)
   └─ Duration: 2 years (post-study work)
   └─ Work: Any employer, any field
   └─ Salary: £30,000-£50,000 (~$40,000-$65,000)
   └─ Path: Can transition to Skilled Worker Visa
   └─ Value: Most relaxed post-study rules 

 Canada (Post-Graduate Work Permit - PGWP)
   └─ Duration: Up to 3 years
   └─ Work: Any Canadian employer
   └─ Salary: CAD $55,000-$80,000 (~$40,000-$60,000)
   └─ Path: Direct path to permanent residency 
   └─ Value: Easiest immigration pathway

 Australia (Post-Study Work Visa - 485)
   └─ Duration: 1.5-3 years (varies by qualification)
   └─ Work: Any Australian employer
   └─ Salary: AUD $60,000-$90,000 (~$40,000-$60,000)
   └─ Path: Can lead to skilled migration visa
   └─ Value: No point-based system needed 

 THIS IS THE BIG WIN:
   You study for 1-2 years, then work for 2-3 years
   = 5-year presence in target country
   = Build experience + network + savings
   = Perfect for immigration or returning home

 STARTING SALARY BY FIELD & COUNTRY

Your {profile.field_of_study} field:

 STEM (Science/Tech/Engineering/Math)
   USA: $70,000-$130,000 (highest!)
   UK: £40,000-£65,000 (~$52,000-$85,000)
   Canada: $55,000-$85,000
   Australia: $65,000-$95,000

 BUSINESS/MBA
   USA: $80,000-$150,000
   UK: £45,000-£75,000 (~$60,000-$100,000)
   Canada: $60,000-$100,000
   Australia: $70,000-$110,000

 HEALTHCARE
   USA: $65,000-$120,000
   UK: £35,000-£60,000 (~$45,000-$80,000)
   Canada: $50,000-$80,000
   Australia: $60,000-$100,000

 SOCIAL SCIENCES/HUMANITIES
   USA: $50,000-$80,000
   UK: £28,000-£45,000 (~$36,000-$60,000)
   Canada: $45,000-$70,000
   Australia: $50,000-$80,000

YOUR FIELD SPECIFICALLY:
   Entry salary: $55,000-$90,000 USD equivalent
   This often EXCEEDS local country salaries 
   International degree = premium 

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 PHASE 2: CAREER PROGRESSION (1-3 Years After)
...
Typical roles:
├─ STEM: Engineer II, Senior Developer, Data Scientist II
├─ MBA: Senior Manager, Consultant, Business Analyst
├─ Other: Senior Specialist, Team Lead, Coordinator
└─ Salary: $80,000-$130,000+

Advancement factors:
 International degree highly valued
 Work experience on resume
 Professional network built
 Performance in first years
 Additional certifications

Promotion likelihood: 60-70% get promoted by year 2-3

 EMPLOYER OPPORTUNITIES

Who will hire you?

1. Fortune 500 companies (40% of grads)
2. Tech giants (30% of STEM grads)
3. Consulting firms (20% of MBA grads)
4. Local/multinational corporations (50% of all)
5. Startups (15-20% of younger grads)

Your profile advantage:
 International degree = diverse perspective
 Foreign work experience = competitive
 Bilingual skills = valuable
 Network effect = referrals

Immigration Pathways Opening Up:

 CANADA (EASIEST!)
   Canadian Experience Class:
   └─ After 1 year work experience
   └─ Can apply for permanent residency
   └─ Much faster than other countries
   └─ Path: Study (2 yr) → Work (3 yr PGWP) → PR 

 AUSTRALIA
   Skilled Migration:
   └─ If your field on demand list
   └─ After 1-2 years experience
   └─ Points-based system
   └─ Path: Study → Work → PR (if qualified)

 UK
   Skilled Worker Visa:
   └─ Employer sponsorship needed
   └─ After work visa expires (2 years)
   └─ Salary threshold: £38,700
   └─ Path: Graduate Visa → Skilled Worker → ILR

 USA
   H-1B Visa:
   └─ Employer sponsorship (many sponsors available!)
   └─ Usually 1-2 years after OPT ends
   └─ Later: Green Card pathway
   └─ Path: OPT → H-1B → Green Card (4-6 years)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 PHASE 3: LONG-TERM OUTCOMES (3+ Years After)

 SALARY PROGRESSION TIMELINE

Year 0 (Graduation): $60,000-$90,000
Year 3: $90,000-$150,000 (+50%)
Year 5: $120,000-$180,000 (+100%)
Year 10: $150,000-$300,000+ (+150-200%)

Senior/Management track:
Year 10+: $200,000-$500,000+ possible

 CAREER OPTIONS AVAILABLE

Option 1: Stay in Study Country
 Visa sponsorship (H-1B in US, Skilled Worker in UK)
 Permanent residency (Canada/Australia)
 Established career & network
 Higher lifetime earnings potential

Option 2: Return Home with International Credentials
 Premium salary (30-50% higher than local grads)
 Leadership positions available
 Multinational company roles
 Entrepreneurship opportunities
 Teaching/Advisory roles

Option 3: Global Mobility
 Work in multiple countries
 Remote work opportunities
 International consulting
 Startup opportunities worldwide
 Choose best opportunities globally

 PERMANENT RESIDENCY OUTCOMES

By Year 5-7, many grads achieve:

 Canada PR: 70% of study-to-PR pathway
 Australia PR: 50% achieve (if field in demand)
 UK ILR: 40% eventually (slower path)
 Green Card: 30% (complex, but possible)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 TOTAL INVESTMENT
   Total program cost: ${profile.budget_max * 2:,}-${profile.budget_max * 3:,}
   Opportunity cost: ${profile.budget_max * 2:,} (work foregone)
   Total: ~${profile.budget_max * 4:,}-${profile.budget_max * 5:,}

 FINANCIAL RETURN

Year 0-1: Break even
Year 2-3: Start gaining (vs staying home)
Year 5: +$150,000-300,000 cumulative
Year 10: +$500,000-$1,000,000+ cumulative

Payback period: 3-4 years typically
Lifetime benefit: $1-3 million+ additional earnings

 EARNINGS COMPARISON

Without international degree:
├─ Home country salary: $25,000-$50,000/year
├─ Growth: Slower (5% annually)
└─ 10-year total: ~$400,000-700,000

With international degree:
├─ Year 1-2: $60,000-$90,000/year
├─ Year 3-7: $100,000-$180,000/year
├─ Year 8+: $150,000-$300,000+/year
└─ 10-year total: ~$1,000,000-1,500,000

DIFFERENCE: +$300,000-$800,000 (minimum!)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 REALISTIC OUTCOMES FOR YOUR PROFILE

Your {profile.field_of_study} background + {profile.intended_degree}:

 LIKELY OUTCOMES (70%+ probability)

1.  Job offer by graduation
2.  Salary $60,000-$100,000 in target country
3.  Promotion to mid-level within 2-3 years
4.  Permanent visa sponsorship pathway available
5.  Salary growth to $120,000+ by year 5
6.  Leadership track becoming possible

⭐ STRETCH OUTCOMES (30-50% probability)

1. ⭐ Permanent residency achieved (especially Canada!)
2. ⭐ Transition to top tech/consulting company
3. ⭐ Salary $150,000+ within 5 years
4. ⭐ Senior/management position by year 5-7
5. ⭐ Ability to support family abroad

 BEST CASE (10-20% probability)

1.  Fast-track management roles
2.  Permanent residency by year 3
3.  Salary $200,000+ within 5-7 years
4.  Entrepreneurship/own company
5.  Global career mobility unlimited

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 SUCCESS FACTORS FOR YOU

To maximize outcomes:

 DO THIS:
   □ Excellent grades (GPA 3.5+) = employers love
   □ 2-3 internships during studies = job offers post-grad
   □ Build professional network (LinkedIn, events)
   □ Join professional associations in field
   □ Consider MBA/additional certification if relevant
   □ Start job search 3-6 months before graduation
   □ Apply to companies with visa sponsorship history
   □ Build portfolio/projects (tech fields)
   □ Get strong recommendation letters
   □ Practice interviews thoroughly

 AVOID:
   □ Skipping internships (loses job opportunity!)
   □ Poor GPA (affects hiring)
   □ Not networking (misses referral jobs)
   □ Gap between graduation and work (visa complications)
   □ Wrong field choice (limit career options)
   □ Relying on job market to find you (be proactive!)
...
1.  FINANCIAL BENEFIT
   └─ Higher salary trajectory
   └─ $500,000-$1,000,000+ lifetime benefit

2.  GEOGRAPHIC FREEDOM
   └─ Work anywhere in world
   └─ Multiple visa options
   └─ Can return home with premium
...
4.  CAREER ACCELERATION
   └─ Faster promotions
   └─ Senior roles available earlier
   └─ Leadership pathway clearer

5.  CREDENTIAL VALUE
   └─ Degree recognized globally
   └─ Employer preference high
   └─ Salary premium guaranteed
...
Your study abroad investment isn't just educational—
it's a strategic career move that compounds over decades.

Most grads look back at their international degree as
THE BEST decision they made for their career.

You're not just getting a degree.
You're investing in your global future! 

NOW TAKE ACTION:
□ Choose universities with strong alumni networks
□ Plan for internships NOW (not during program)
□ Network during your studies
□ Build your professional profile
□ Prepare for job search early

Your international degree will open doors
most local degrees cannot! """
...
async def get_predefined_questions(
    ...
    return {
        "questions": [
            ...
            {
                "id": "funding_options",
                "title": PREDEFINED_QUESTIONS["funding_options"]["title"],
                "description": PREDEFINED_QUESTIONS["funding_options"]["description"],
                "suggested_message": "What are my funding options?"
            },
            {
                "id": "career_outcomes",
                "title": PREDEFINED_QUESTIONS["career_outcomes"]["title"],
                "description": PREDEFINED_QUESTIONS["career_outcomes"]["description"],
                "suggested_message": "What are the career outcomes after studying abroad?"
            }
        ]
    }
